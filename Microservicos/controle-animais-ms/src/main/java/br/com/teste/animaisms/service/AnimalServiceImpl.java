...
public class AnimalServiceImpl implements AnimalService {
    ...
    @Override
    public Optional<AnimalDto> obterPorId(Long id) {
    ...
    @Override
    public List<AnimalDto> obterPorDono(Long dono) {
    ...
    @Override
    public boolean definirComoMorto(Long id) {
        Optional<Animal> animal = repo.findById(id);
        if(animal.isPresent()) {
    ...
    @Override
    public AnimalDto atualizarAnimal(Long id, AnimalDto animal) {
        animal.setId(id);
        return salvarAnimal(animal);
    }
