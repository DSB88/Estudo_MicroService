...
public class AnimalController {
    ...
    public ResponseEntity<List<AnimalModeloResponse>> obterPorDono(@PathVariable Long dono) {
    ...
    @GetMapping(value="/{id}")
    public ResponseEntity<AnimalModeloResponse> obterPorId(@PathVariable Long id) {
    ...
    @PutMapping(value="/{id}")
    public ResponseEntity<AnimalModeloResponse> atualizarAnimal(@PathVariable Long id,
    ...
    public ResponseEntity<Void> definirMorto(@PathVariable Long id) {
