...
public class PessoaController {
    ...
    @GetMapping(value="/{id}")
    public ResponseEntity<PessoaModeloResponseDetalhes> obterPorId(@PathVariable Long id) {
    ...
    @PutMapping(value="/{id}")
    public ResponseEntity<PessoaModeloResponse> atualizarPessoa(@PathVariable Long id,
